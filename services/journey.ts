...
export const PLACES: Place[] = [
  ...
  { id: 'taipei', name: '臺北', emoji: '🏙️', lon: 121.56, lat: 25.03, label: 'left', friend: { emoji: '🐿️', name: '小松鼠' },
    story: '臺北一〇一好高好高，看起來像一節一節的竹子。', souvenir: { emoji: '🎋', name: '竹子書籤' } },
  ...
  { id: 'taichung', name: '臺中', emoji: '🌈', lon: 120.68, lat: 24.14, friend: { emoji: '🐶', name: '小狗' },
    story: '臺中有一個彩虹村，牆上、地上都畫滿了彩色的圖。', souvenir: { emoji: '🥮', name: '太陽餅' } },
  ...
  { id: 'tainan', name: '臺南', emoji: '🏯', lon: 120.20, lat: 22.99, friend: { emoji: '🐱', name: '小貓' },
    story: '臺南有好老好老的城堡，還有好多好吃的小吃。', souvenir: { emoji: '🍜', name: '擔仔麵' } },
  ...
  { id: 'taitung', name: '臺東', emoji: '🎈', lon: 121.15, lat: 22.76, friend: { emoji: '🐃', name: '水牛' },
    story: '臺東的天空飄著好多熱氣球，有的像動物，有的像房子。', souvenir: { emoji: '🎈', name: '熱氣球' } },
