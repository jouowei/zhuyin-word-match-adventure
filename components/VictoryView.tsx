...
export const VictoryView: React.FC<VictoryViewProps> = ({ onHome, onReplay }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-yellow-50 p-4 overflow-hidden">
      ...
      <div className="flex gap-4">
        ...
        <button 
          onClick={onReplay}
          className="bg-green-500 hover:bg-green-600 text-white text-xl font-bold py-4 px-8 rounded-2xl shadow-lg animate-pulse"
        >
          再玩一次
        </button>
      </div>
