...
export const JOURNEY_SCENES: Record<string, string> = {
  ...
  // The two ways in after choosing a player (ModePickView)
  'mode-adventure': "A little red train running along Taiwan's east coast: tall green mountains dropping steeply into a blue sea, a railway winding along the shore between the mountains and the sea, a hot air balloon high in the sky, white waves on the rocks. A cheerful, inviting start of a journey. No animals.",
